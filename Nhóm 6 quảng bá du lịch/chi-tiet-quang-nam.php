...
if (isset($_SESSION['user_id'])) {
    ...
    $pageTitle = "TOUR QUẢNG NAM"; // Đổi tên cho từng trang
...
// Lấy tổng số mục
$totalQuery = "SELECT COUNT(*) as total FROM posts WHERE location LIKE N'%Quảng Nam'";
...
$query = "SELECT location, descript, img, ggmap FROM posts WHERE location LIKE N'%Quảng Nam' LIMIT $offset, $itemsPerPage"; 
...
<body>
    ...
    <section class="tour-detail">
        <div class="tour-title">
            <div class="tour-VN">
                <h1>Du lịch Quảng Nam</h1>
                <img src="img/Quang Nam.jpeg">
                <h2>Gợi ý</h2>
