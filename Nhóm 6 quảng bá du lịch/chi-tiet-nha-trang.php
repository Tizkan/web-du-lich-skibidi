...
if (isset($_SESSION['user_id'])) {
    ...
    $pageTitle = "TOUR NHA TRANG"; // Đổi tên cho từng trang
...
// Lấy tổng số mục
$totalQuery = "SELECT COUNT(*) as total FROM posts WHERE location LIKE N'%Nha Trang'";
...
$query = "SELECT location, descript, img, ggmap FROM posts WHERE location LIKE N'%Nha Trang' LIMIT $offset, $itemsPerPage"; 
