...
// Lấy tổng số mục
$totalQuery = "SELECT COUNT(*) as total FROM posts WHERE location LIKE N'%Phú Thọ'";
...
$query = "SELECT location, descript, img, ggmap FROM posts WHERE location LIKE N'%Phú Thọ' LIMIT $offset, $itemsPerPage"; 
...
<body>
    ...
    <section class="tour-detail">
        <div class="tour-title">
            <div class="tour-VN">
                <h1>Du lịch Phú Thọ</h1>
                <img class="tour-img" src="img/Phu Tho.jpg" alt="Phú Thọ">
                <h2>Gợi ý</h2>
