...
if (isset($_SESSION['user_id'])) {
    ...
    $pageTitle = "TOUR HUẾ"; // Đổi tên cho từng trang
...
// Lấy tổng số mục
$totalQuery = "SELECT COUNT(*) as total FROM posts WHERE location LIKE N'%Huế'";
...
$query = "SELECT location, descript, img, ggmap FROM posts WHERE location LIKE N'%Huế' LIMIT $offset, $itemsPerPage"; 
