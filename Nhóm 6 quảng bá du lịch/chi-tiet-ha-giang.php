...
// Lấy tổng số mục
$totalQuery = "SELECT COUNT(*) as total FROM posts WHERE location LIKE N'%Hà Giang'";
...
$query = "SELECT location, descript, img, ggmap FROM posts WHERE location LIKE N'%Hà Giang' LIMIT $offset, $itemsPerPage"; 
...
<body>
    ...
    <section class="tour-detail">
        <div class="tour-title">
            <div class="tour-VN">
                <h1>Du lịch Hà Giang</h1>
                <img class="tour-img" src="img/Ha Giang.jpg" alt="Hà Giang">
                <h2>Gợi ý</h2>
