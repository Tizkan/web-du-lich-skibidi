...
if (isset($_SESSION['user_id'])) {
    ...
    $pageTitle = "TOUR SAPA"; // Đổi tên cho từng trang
...
// Lấy tổng số mục
$totalQuery = "SELECT COUNT(*) as total FROM posts WHERE location LIKE N'%Sapa'";
...
$query = "SELECT location, descript, img, ggmap FROM posts WHERE location LIKE N'%Sapa' LIMIT $offset, $itemsPerPage"; 
...
<body>
    ...
    <section class="tour-detail">
        <div class="tour-title">
            <div class="tour-VN">
                <h1>Du lịch SAPA</h1>
                <img class="tour-img" src="img/Chi-tiet-SAPA/anh-chinh.jpg" alt="Quy Nhơn">
                <h2>Gợi ý</h2>
