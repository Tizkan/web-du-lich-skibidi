...
if (isset($_SESSION['user_id'])) {
    ...
    $pageTitle = "TOUR QUẢNG NGÃI"; // Đổi tên cho từng trang
...
// Lấy tổng số mục
$totalQuery = "SELECT COUNT(*) as total FROM posts WHERE location LIKE N'%Quảng Ngãi'";
...
$query = "SELECT location, descript, img, ggmap FROM posts WHERE location LIKE N'%Quảng Ngãi' LIMIT $offset, $itemsPerPage"; 
...
<body>
    ...
    <section class="tour-detail">
        <div class="tour-title">
            <div class="tour-VN">
                <h1>Du lịch Quảng Ngãi</h1>
                <img src="img/Quang Ngai.jpeg">
                <h2>Gợi ý</h2>
                <?php
